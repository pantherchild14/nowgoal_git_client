...
//     const { e, odds, statusRedux } = props; // oddsRedux,
...
//         return acc;
//     }, {});
//     // , ODDS_AH_HT, ODDS_EURO_FT, ODDS_EURO_HT , ODDS_OU_HT
...
//                     {/* oddRT && oddRT.Handicap !== undefined ? oddRT.Handicap : ODDS_AH_FT.l.g */}
//                     <div className="tr__col handicap.instantHandicap" id={`goal_${e.MATCH_ID}`}><span>{ODDS_AH_FT.l.g < 0 ? -ODDS_AH_FT.l.g : ODDS_AH_FT.l.g}</span></div>
//                     <div className="tr__col handicap.instantHandicap" id={`goalLive_${e.MATCH_ID}`}><span>{ODDS_AH_FT.l.g < 0 ? -ODDS_AH_FT.l.g : ODDS_AH_FT.l.g}</span></div>
//                 </div>
//             </td>
//             <td>
//                 <div className="tr__row">
//                     {/* oddRT && oddRT.HomeHandicap !== undefined ? oddRT.HomeHandicap : ODDS_AH_FT.l.u */}
//                     <div className="tr__col handicap.instantHome" id={`upodds_${e.MATCH_ID}`}>{ODDS_AH_FT.l.u}</div>
//                     {/* oddRT && oddRT.AwayHandicap !== undefined ? oddRT.AwayHandicap : ODDS_AH_FT.l.d */}
