...
// const TableContent = ({ schedule, odds, selectedHandicap, selectedOddHandicap, selectedOddOver, selectedOver, statusRedux }) => { // oddsRedux
...
//                 return <DataTable key={e.MATCH_ID} e={e} odds={matchedOddsItem} statusRedux={matchedScheduleItemRT} />; // oddsRedux={matchedOddsItemRT}
//               }
//             }
